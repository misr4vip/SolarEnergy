...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
                R.id.nav_home, R.id.nav_Connection, R.id.nav_Info,R.id.nav_Traffic,R.id.nav_Solarenergy), drawerLayout)
        ...
        if (fuser != null) {
            ...
            fuser.addValueEventListener(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    tv_headerUser.text = fname + " " + lname
                    tvHeaderEmail.text = p0?.child("email").getValue(String::class.java)!!
                }
